...
export default function CadastrarAnimalModal({
  isOpen,
  onClose,
  onSave,
}: CadastrarAnimalModalProps) {
  ...
  const handleSubmit = (e?: React.FormEvent) => {
    ...
    if (!formData.nome || !formData.idade || !formData.comoAdotar) {
      alert(
        "Preencha todos os campos obrigatórios (Nome, Idade e Como Adotar)",
      );
      return;
    }
  ...
  return (
    <div className={styles.backdrop} onClick={onClose}>
      <div className={styles.page} onClick={(e) => e.stopPropagation()}>
        ...
        <header className={styles.pageHeader}>
          <div>
            ...
            <p className={styles.pageSubtitle}>
              Preencha os detalhes para integrar um novo pet ao nosso sistema de
              gestão e cuidado.
            </p>
          </div>
        ...
        <form className={styles.bentoGrid} onSubmit={handleSubmit}>
          ...
          <div className={styles.colLeft}>
              ...
              <section className={styles.card}>
                ...
                <div className={styles.cardBody}>
                  ...
                  <div className={styles.row2}>
                    <div className={styles.fieldGroup}>
                      <label className={styles.labelUpper}>
                        Idade Aproximada
                      </label>
                      <input
                        className={styles.input}
                    ...
                    <div className={styles.fieldGroup}>
                      ...
                      <input
                        ...
                        value={formData.raca}
                        onChange={(e) =>
                          handleInputChange("raca", e.target.value)
                        }
                      />
                    </div>
                  </div>
            ...
            <section className={styles.card}>
              <div className={styles.cardHeader}>
                <span
                  className={`${styles.cardIcon} ${styles.cardIconSecondary}`}
                >
                    ...
                    <div className={styles.pillGroup}>
                      {[
                        ...
                        <button
                          key={value}
                          type="button"
                          className={`${styles.pill} ${formData.porte === value ? styles.pillActive : ""}`}
                          onClick={() => handleInputChange("porte", value)}
                        >
                          {label}
                        </button>
                      ))}
              ...
              <div className={styles.cardHeader}>
                ...
                <div>
                  ...
                  <p className={styles.cardSubtitle}>
                    Selecione todas as que descrevem bem o animal
                  </p>
                </div>
              </div>
              <div className={styles.cardBody}>
          ...
          <div className={styles.colRight}>
            ...
            <section className={styles.card}>
              ...
              <div className={styles.cardBody}>
                ...
                <div className={styles.coverNotice}>
                  ...
                  <span>
                    A <strong>primeira imagem</strong> enviada será usada como
                    capa do perfil do animal.
                  </span>
                </div>
                      ...
                      <div className={styles.previewGrid}>
                        {fotos.map((foto, index) => (
                          <div key={index} className={styles.previewWrapper}>
                            ...
                            {index === 0 && (
                              <span className={styles.mainLabel}>★ Capa</span>
                            )}
                          </div>
                        ))}
                      </div>
            ...
            <section className={styles.card}>
              <div className={styles.cardHeader}>
                <span
                  className={`${styles.cardIcon} ${styles.cardIconTertiary}`}
                >
                ...
                <div className={styles.checkRow}>
                  <label className={styles.checkCard}>
                    <input
                      ...
                      onChange={(e) =>
                        handleInputChange("vacinado", e.target.checked)
                      }
                    />
                  ...
                  <label className={styles.checkCard}>
                    <input
                      ...
                      onChange={(e) =>
                        handleInputChange("castrado", e.target.checked)
                      }
                    />
        ...
        {/* ===== CARD: Como Adotar (full width abaixo do grid) ===== */}
          ...
          <section className={styles.card}>
            <div className={styles.cardHeader}>
              ...
              <div>
                ...
                <p className={styles.cardSubtitle}>
                  Explique o processo de adoção deste animal
                </p>
              </div>
            </div>
            <div className={styles.cardBody}>
              <textarea
                ...
                onChange={(e) =>
                  handleInputChange("comoAdotar", e.target.value)
                }
              />
            </div>
          </section>
        ...
        <footer className={styles.pageFooter}>
          <div className={styles.footerInfo}>
            <span
              className="material-symbols-outlined"
              style={{ fontSize: "20px", color: "#a93249" }}
            >
              info
            </span>
